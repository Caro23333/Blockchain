...
var node_list []network.NodeArgs = []network.NodeArgs{
	{IP: "10.1.0.95", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.96", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.94", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.119", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.104", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.105", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.107", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.109", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.110", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
	{IP: "10.1.0.111", Port: "8056", PublicKey: *new(signature.JSONPublicKey), KeyValid: false},
}
